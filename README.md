...
```bash
curl -J -L -o release.tar.gz https://github.com/groupdocs-total/GroupDocs.Total-for-Java-Spring/releases/download/0.4.57/release.tar.gz
tar -xvzf release.tar.gz
cd release
java -jar total-spring-0.4.57.jar configuration.yaml
## Open http://localhost:8080/ in your favorite browser.
```
